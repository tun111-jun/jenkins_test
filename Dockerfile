...
COPY /var/jenkins_home/workspace/uplog/build/resources/main/application.yml /app/application.yml

COPY build/libs/mysql-connector-j-8.0.33.jar /app/lib/mysql-connector-java-8.0.33.jar
# 컨테이너 내에서 실행할 명령어 설정
